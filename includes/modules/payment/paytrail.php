	...
	function process_button()
	{
		...
		try {
			...
			if ($e->hasResponse()) {
				...
				echo "<a href='index.php?main_page=contact_us' title='" .MODULE_PAYMENT_PAYTRAIL_PAYMENT_ERROR ."' target='_blank'><strong>" .MODULE_PAYMENT_PAYTRAIL_PAYMENT_ERROR ." => " .STORE_TELEPHONE_CUSTSERVICE. "</strong></a>";
			}
		}
