...
=======
	...
	function process_button()
	{
		...
		try {
			...
			if ($e->hasResponse()) {
				$response = $e->getResponse();
				echo "<div style='color:red'> Unexpected HTTP status code: {$response->getStatusCode()}\n\n";
				echo "&nbsp;&nbsp;<a href='index.php?main_page=contact_us' target='_blank'><strong>" .MODULE_PAYMENT_PAYTRAIL_PAYMENT_ERROR ."</strong></a>";
				echo "<br>" .MODULE_PAYMENT_PAYTRAIL_SELECET_OTHER;
				echo "<br></div><div class='buttonRow back'>" .zen_back_link() . zen_image_button(BUTTON_IMAGE_BACK, BUTTON_BACK_ALT) . "</a></div>";
			}
		}
